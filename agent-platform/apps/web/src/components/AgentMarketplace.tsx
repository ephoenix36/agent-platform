...
import { Search, Star, TrendingUp, Clock, DollarSign, Users, Filter, Zap, Shield, CheckCircle } from 'lucide-react';
    ...
    setAgents([
      {
        ...
        security: {
          ...
          level: 'safe',
          verified: true,
          scannedAt: '2025-10-29T10:00:00Z',
        },
      ...
      },
      {
        ...
        security: {
          ...
          level: 'safe',
          verified: true,
          scannedAt: '2025-10-28T14:30:00Z',
        },
      ...
      },
      {
        ...
        security: {
          ...
          level: 'safe',
          verified: true,
          scannedAt: '2025-10-27T09:15:00Z',
        },
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Shield className={`w-4 h-4 ${
                      agent.security.level === 'safe' ? 'text-green-400' :
                      agent.security.level === 'low' ? 'text-blue-400' :
                      agent.security.level === 'medium' ? 'text-yellow-400' :
                      'text-red-400'
                    }`} />
                    <div>
                      <div className="text-xs text-gray-400">Security Score</div>
                      <div className={`text-sm font-semibold ${
                        agent.security.score >= 95 ? 'text-green-400' :
                        agent.security.score >= 85 ? 'text-blue-400' :
                        agent.security.score >= 70 ? 'text-yellow-400' :
                        'text-red-400'
                      }`}>
                        {agent.security.score}/100
                      </div>
                    </div>
                  </div>
